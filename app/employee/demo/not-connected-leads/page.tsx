...
function NotConnectedLeadsContent() {
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold mb-2">Not Connected Leads</h1>
            <p className="text-muted-foreground">
              Showing {leads.length} lead{leads.length !== 1 ? "s" : ""} that couldn't be reached
            </p>
          </div>
